...
extern int crc_algorithm_update(const crc_model_t *model, const uint8_t *buf, size_t len, void *value);
extern int crc_algorithm_final(const crc_model_t *model, void *value);
