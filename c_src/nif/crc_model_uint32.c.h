...
static crc_model_stub_t crc_model_uint32_stubs[] = {
    /* crc_32 */
    {{NULL, NULL}, false, 0, "crc_32", 0, "crc_32", "CRC-32"},
    {{NULL, NULL}, false, 0, "crc_32", 0, "crc_32_adccp", "CRC-32/ADCCP"},
    {{NULL, NULL}, false, 0, "crc_32", 0, "pkzip", "PKZIP"},
    /* crc_32c */
    {{NULL, NULL}, false, 0, "crc_32c", 0, "crc_32c", "CRC-32C"},
    {{NULL, NULL}, false, 0, "crc_32c", 0, "crc_32_castagnoli", "CRC-32/CASTAGNOLI"},
    {{NULL, NULL}, false, 0, "crc_32c", 0, "crc_32_interlaken", "CRC-32/INTERLAKEN"},
    {{NULL, NULL}, false, 0, "crc_32c", 0, "crc_32_iscsi", "CRC-32/ISCSI"},
    /* END */
    {{NULL, NULL}, true}};

static crc_model_uint32_t crc_model_uint32_list[] = {
    /* width=32 poly=0x04c11db7 init=0xffffffff refin=true refout=true xorout=0xffffffff check=0xcbf43926 residue=0xdebb20e3
       name="CRC-32" */
    {{{NULL, NULL}, true, 0, "crc_32", 32},
     false,
     32,
     0x04c11db7,
     0xffffffff,
